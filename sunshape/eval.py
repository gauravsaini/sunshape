...
from sunshape.hf import load_model_and_tokenizer, load_trace_artifact
from sunshape.methods import build_cache_factory, canonical_method_name
...
def run_cache_eval_loaded(
    *,
    ...
    for mode in modes:
        resolved_mode = canonical_method_name(mode)
        cache_factory = build_cache_factory(
